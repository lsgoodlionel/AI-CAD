/**
 * /review（无项目 id）：项目选择器，选中后跳 /projects/:id/review。
 * 结构参照 pages/project/Hub/ProjectPicker.tsx 与 pages/quantities/ProjectSelector.tsx
 * （只读借鉴，不改动这两个文件）。
 */
...
export default function ProjectSelector(): JSX.Element {
  ...
  const handleEnter = (): void => {
    ...
    navigate(`/projects/${selectedId}/review`)
  }
      ...
      <div style={{ padding: 24 }}>
        <Card>
          <Space direction="vertical" align="center" style={{ width: '100%', padding: '48px 0' }}>
            <FileSearchOutlined style={{ fontSize: 40, color: '#bfbfbf' }} />
