...
|---|---|---|---|---|---|
| 2026-07-14 | ❌ 否 | — | 待权重释放后启动复核 | Phase D 泳道5 | 复查 HuggingFace/GitHub 仍无明确权重 asset；**新增跟踪 CADSpotting**（arXiv 2412.07377，大规模 CAD 鲁棒 panoptic spotting）——待评估其许可与权重可用性，作为 VecFormer 之外的天花板候选 |
